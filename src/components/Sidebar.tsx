                    ...
                    return (
                        <li key={item.id} className="relative">
                            <button
                                ...
                                className={`w-full flex items-center gap-3 py-2 px-2 rounded-lg group transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-mars-accent/40 ${
                                    active
                            ...
                            >
                                <span
                                    className={`flex items-center justify-center w-10 h-10 rounded-md ${
                                        active ? 'bg-gradient-to-br from-mars-accent to-mars-red-deep text-white' : 'bg-white/3 text-gray-200 group-hover:bg-white/5'
                                    }`}
                                >
