      ...
      <main className="flex-1 overflow-y-auto p-6 md:p-10 bg-bg-dark relative">
        ...
        <div className="space-y-10 animate-fade-in">
            ...
            {activeSection === 'overview' && (
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <StatusCard title="Atmosphäre" value="98.5%" color="text-green-400" borderColor="border-green-500/50" />
                        <StatusCard title="Aktive Fahrzeuge" value="15/18" color="text-mars-accent" borderColor="border-mars-accent/50" />
                        <StatusCard title="O2 Reserven" value="34 Tage" color="text-mars-red-deep" borderColor="border-mars-red-deep/50" />
            ...
            {activeSection === 'vehicles' && (
                <section>
                    <h3 className="text-2xl font-semibold text-mars-accent mb-4">Fahrzeugflotte</h3>
                    <div className="bg-card-bg p-6 rounded-lg border border-gray-700">
                        <p>Hier würde die Tabelle der Rover stehen...</p>
                    </div>
                </section>
            )}
...
// Hilfskomponente für die Karten
const StatusCard = ({ title, value, color, borderColor }: any) => (
    <div className={`bg-card-bg p-4 rounded-lg border ${borderColor} shadow-md`}>
